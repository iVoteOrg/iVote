              ...
              <div className = "Particle_screen_1" id = "particle">
                  ...
                  <div id="text_div center_all">
                      <div className="center_all">
                        ...
                        <div>
                            <Button className=" btn buy-buton" href="https://faucet.rinkeby.io/"  target="_blank">Buy Faucets</Button>
                        </div>
                        <hr style={{height:"20px", width:"150vh", margin:"50px, 0px"}} className="horizoon"/>
                        <div>
                            <Button href="/ElectionParties" className="ml-4 btn buy-buton">Proceed To Voting</Button>
                        </div>
                      </div>
                  </div>
              </div>
