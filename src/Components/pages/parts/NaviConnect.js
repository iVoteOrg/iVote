          ...
          <Container className="p">
            ...
            <Navbar.Collapse id="basic-navbar-nav">
              <Nav className="me-auto">
                <Nav.Link href="/contact">Contact<span className ="span_class">_</span>Us</Nav.Link>
                <Button href="#" className="ml-4">Connect<span className ="span_class">_</span>Account</Button>
